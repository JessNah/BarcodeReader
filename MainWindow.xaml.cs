...
namespace Microsoft.Samples.Kinect.ColorBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private WriteableBitmap reverseBitmap = null;
        ...
        public MainWindow()
        {
            ...
            this.reverseBitmap = new WriteableBitmap(colorFrameDescription.Width, colorFrameDescription.Height, 96.0, 96.0, PixelFormats.Bgr32, null);
        ...
        private void ScreenshotButton_Click(object sender, RoutedEventArgs e)
        {
            if (this.colorBitmap != null)
            {
                ...
                this.reverseBitmap = this.colorBitmap;
                ...
                if (result != null)
                {
                    this.StatusText = result.BarcodeFormat.ToString() + "      " + result.Text;
                }
